...
describe designs in a neutral notation; seven language packs translate
...
Seven language packs give the concrete syntax: `functional-javascript`,
`functional-typescript`, `functional-typescript-effect`,
`functional-typescript-ts-pattern`, `functional-typescript-react`,
`functional-typescript-react-nextjs`, `functional-elixir-phoenix`.
...
- **Only the first place in a ranking is meaningful.** A median of 34 of
  the 41 skills score exactly zero on any given case, and ties break by
