...
const CASES = [
  ...
  ['a reference no skill links to', join('plugin', 'skills', 'folding-over-data', 'SKILL.md'),
    ['[monoids.md](references/monoids.md)', 'monoids.md'], 'is not linked from its own SKILL.md'],
