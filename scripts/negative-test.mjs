...
const CASES = [
  ...
  ['a documented count that no longer matches reality',
    ...
    ['holds thirty-seven fuller problems', 'holds thirty-five fuller problems'],
    'but there are 37', 'validate-counts.mjs'],
  ['a claim whose sentence was rewritten, so nothing checks it',
    join('evals', 'README.md'),
    ['holds thirty-seven fuller problems', 'holds a good number of problems'],
