...
const CASES = [
  ...
  ['a library pack that never names the major its shapes target',
    join('plugin', 'skills', 'functional-typescript-xstate', 'SKILL.md'),
    ['installed version', 'current version', 'all'],
    'never tells the reader to check the installed'],
  ...
  ['a broken relative link in a file outside plugin/skills', 'README.md',
    ...
    'broken link ->'],
  ['a skill the version bump cannot carry a number to', SKILL,
    ['\n  version: ', '\n  release: '],
    'no "  version:" line in the metadata block', 'bump-version.mjs'],
